...
export default function SyncUKCategoryTaxonomies() {
  ...
  const operation = getOperationMeta("sync-uk-category-taxonomies");
  ...
  return (
    <div className="page-limit-1440 space-y-6">
      ...
      <OperationOverview operationId="sync-uk-category-taxonomies" />

      <OperationRunSection operationId="sync-uk-category-taxonomies">
        <Card>
      ...
      <OperationDependencies operationId="sync-uk-category-taxonomies" locale={form.locale} />
